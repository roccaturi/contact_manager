...
RSpec.describe EmailAddressesController, type: :controller do
  ...
  let(:valid_attributes) { {address: 'tessa@tester.com', contact_id: test_person.id, contact_type: 'Person'}}
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the contact of the created email_address" do
        post :create, {:email_address => valid_attributes}, valid_session
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) { {address: 'founder@startup.io', contact_id: test_person.id, contact_type: 'Person'} }
      ...
      it "updates the requested email_address" do
        ...
        expect(email_address.contact_id).to eq(test_person.id)
      end
      it "assigns the requested email_address as @email_address" do
        email_address = EmailAddress.create! valid_attributes
      ...
      it "redirects to the contact of the email_address" do
        email_address = EmailAddress.create! valid_attributes
        put :update, {:id => email_address.to_param, :email_address => valid_attributes}, valid_session
